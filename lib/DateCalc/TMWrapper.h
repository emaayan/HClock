...
public:
    TMWrapper(const year_t year, const month_t month, const day_t day,const tm tm);
    TMWrapper(const tm tm, const hour_t hour, const minute_t minute, const second_t second);
